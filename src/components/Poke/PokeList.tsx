...
const PokeList = ({name, url, details}: DataList) => {
  ...
  return (
    <>
    {details === true ? (
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" onClick={() => detailsPoke(+url.split('/').slice(-2)[0])}>
        <a>
